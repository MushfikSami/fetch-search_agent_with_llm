...
rate_limiter = {
	number_of_requests = 50, -- The number of requests that are allowed within a provided time limit.
	time_limit = 10, -- The time limit in which the number of requests that should be accepted.
}
